...
| [Progressive Disclosure](guidelines/progressive-disclosure.md) | Choosing where instructions belong; adding, moving, promoting, pruning, or routing shared, repo, domain, and local `.ai` guidelines. |
